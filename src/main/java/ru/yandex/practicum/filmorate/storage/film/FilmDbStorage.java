...
public class FilmDbStorage implements FilmStorage {
    ...
    private Film mapRowToFilm(ResultSet resultSet, int rowNum) throws SQLException {
         Film film = Film.builder()
                 ...
                 .releaseDate((LocalDate) resultSet.getObject("RELEASE_DATE"))
                 .mpa(getMpaByFilmId(resultSet.getInt("ID")))
                 .build();
    ...
    private Mpa getMpaByFilmId(int id) {
        String sql = "SELECT * FROM MPA WHERE MPA_ID IN (SELECT MPA_ID FROM FILM WHERE FILM_ID = ?)";
