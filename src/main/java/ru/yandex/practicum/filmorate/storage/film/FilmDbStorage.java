...
public class FilmDbStorage implements FilmStorage {
    ...
    private final String GENRE_ID = "fg.GENRE_ID = ?";
    private final String YEAR = "YEAR(RELEASE_DATE) = ?";
    private final String LEFT = "LEFT %s";
    private final String FILM_NAME = "f.NAME";
    private final String DIRECTOR_NAME = "d.DIRECTOR_NAME";
    private final String GET_ALL_FILMS = "SELECT f.ID, f.NAME, f.DESCRIPTION, f.DURATION, f.RELEASE_DATE, f.MPA_ID, m.NAME AS MPA_NAME, " +
            "(SELECT COUNT(l.USER_ID) FROM LIKES l WHERE f.ID = l.FILM_ID) countLikes " +
            "FROM FILM f " +
            "JOIN MPA m ON f.MPA_ID = m.MPA_ID ";
    private final String JOIN_FILM_DIRECTOR = "JOIN FILM_DIRECTOR fd ON f.ID = fd.FILM_ID";
    private final String JOIN_DIRECTOR = "JOIN DIRECTOR d ON d.DIRECTOR_ID = fd.DIRECTOR_ID";
    private final String JOIN_FILM_GENRE = "JOIN FILM_GENRE fg ON f.ID = fg.FILM_ID";
    private final String JOIN_GENRE = "JOIN GENRE g ON g.GENRE_ID = fg.GENRE_ID";
    private final String LCASE = "LCASE(%s) LIKE CONCAT('%%', ?, '%%')";
    private final String GROUP_BY_ID = "GROUP BY f.ID";
    private final String ORDER_BY_COUNT_LIKES_DESC = "ORDER BY countLikes DESC";
