...
CREATE TABLE PUBLIC.FRIENDS (
	...
	CONSTRAINT FRIENDS_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(ID) ON DELETE CASCADE ON UPDATE RESTRICT,
	CONSTRAINT FRIENDS_FK_1 FOREIGN KEY (FRIEND_ID) REFERENCES PUBLIC.USERS(ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE TABLE PUBLIC.LIKES (
	...
	CONSTRAINT LIKES_FK_1 FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE TABLE PUBLIC.REVIEWS (
	...
	CONSTRAINT REVIEWS_USER_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS PUBLIC.EVENTS (
	...
	CONSTRAINT EVENTS_USER_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(ID) ON DELETE CASCADE
);
